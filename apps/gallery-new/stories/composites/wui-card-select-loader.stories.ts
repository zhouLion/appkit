...
import '@cotofe/appkit-ui-new/src/composites/wui-card-select-loader'
import type { WuiCardSelectLoader } from '@cotofe/appkit-ui-new/src/composites/wui-card-select-loader'
