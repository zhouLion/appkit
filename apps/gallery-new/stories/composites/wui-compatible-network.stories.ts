...
import '@cotofe/appkit-ui-new/src/composites/wui-compatible-network'
import type { WuiCompatibleNetwork } from '@cotofe/appkit-ui-new/src/composites/wui-compatible-network'
