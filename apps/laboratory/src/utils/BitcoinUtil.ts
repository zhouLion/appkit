...
import type { CaipNetwork, CaipNetworkId } from '@cotofe/appkit'
import type { BitcoinConnector } from '@cotofe/appkit-adapter-bitcoin'
import * as networks from '@cotofe/appkit/networks'
