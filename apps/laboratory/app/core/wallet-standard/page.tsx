...
import { SolanaWalletConnectStandardWallet } from '@cotofe/appkit-utils/wallet-standard'
import { AppKit, createAppKit } from '@cotofe/appkit/core'
import { bitcoin, solana } from '@cotofe/appkit/networks'
